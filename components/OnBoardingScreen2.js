    ...
    return(
        <View style={styles.container}>
            <View style={[appStyles.top, styles.topContainer]}>
                ...
                <Image source={require('../assets/page1.png')} style={styles.img}/>
            </View>
            <View style={styles.bottomContainer}>
                <Text style={styles.title}> Fast, Secure & Trusted</Text>
                <Text style={styles.description}>Fast and Safe Video calling guaranteed</Text>
