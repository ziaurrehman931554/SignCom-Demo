    ...
    return(
        <View style={styles.container}>
            <View style={[appStyles.top, styles.topContainer]}>
                ...
                <Image source={require('../assets/page3.png')} style={styles.img}/>
            </View>
            <View style={styles.bottomContainer}>
                <Text style={styles.title}>Bridging the Gap</Text>
                <Text style={styles.description}>Helps people connect online irrespective of hearing & speaking Disabilities in virtual world</Text>
